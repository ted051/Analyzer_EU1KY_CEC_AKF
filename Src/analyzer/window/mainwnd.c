...
if (DatumDDMMYYYY)
{
    ...
    //modified by KD8CEC
    hbTimestamp = (TEXTBOX_t) {.x0 = 27, .y0 = 257, .text = "" AAVERSION "," BUILD_TIMESTAMP_D, .font = FONT_FRAN,
                            .fgcolor = LCD_GRAY, .bgcolor = LCD_RGB(64, 64, 64) };
} else {
   hbTimestamp = (TEXTBOX_t) {.x0 = 27, .y0 = 257, .text = "" AAVERSION "," BUILD_TIMESTAMP_US, .font = FONT_FRAN,
                            .fgcolor = LCD_GRAY, .bgcolor = LCD_RGB(64, 64, 64) };
...
static const TEXTBOX_t tb_col[] = {
    ...
    (TEXTBOX_t){ .x0 = XXa+240, .y0 = 100, .text = "Beep On/Off", .font = FONT_FRANBIG, .width = 200, .height = 34, .center = 1,
...
static const TEXTBOX_t tb_menu1[] = {
    ...
    (TEXTBOX_t){ .x0 = COL2, .y0 = 10, .text = " Accu Settings ", .font = FONT_FRANBIG, .width = 210, .height = 34, .center = 1,
                 .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = MenuAccu , .cbparam = 1,.next = (void*)&tb_menu1[5]},
    (TEXTBOX_t){ .x0 = COL2, .y0 = 60, .text = " Date/Time ", .font = FONT_FRANBIG, .width = 210, .height = 34, .center = 1,
                 .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = MenuRTC , .cbparam = 1,.next = (void*)&tb_menu1[6]},

    (TEXTBOX_t){ .x0 = COL2, .y0 = 110, .text = "Manage SnapShot", .font = FONT_FRANBIG, .width = 210, .height = 34, .center = 1,
                 .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = Reload_Proc, .cbparam = 1,.next = (void*)&tb_menu1[7]},

    (TEXTBOX_t){ .x0 = COL2, .y0 = 160, .text = "USB HS Transfer", .font = FONT_FRANBIG, .width = 210, .height = 34, .center = 1,
                 .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = USBD_Proc , .cbparam = 1,.next = (void*)&tb_menu1[8]},

    (TEXTBOX_t){ .x0 = COL2, .y0 = 210, .text = " Flip Screen ", .font = FONT_FRANBIG, .width = 210, .height = 34, .center = 1,
                 .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = Rotate , .cbparam = 1,.next = (void*)&tb_menu1[9]},
