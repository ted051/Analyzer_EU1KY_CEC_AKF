...
extern float complex LC_OSL_CorrectZ(uint32_t fhz, float complex zMeasured);

void DSP_MeasureLC(uint32_t freqHz, int applyErrCorr, int applyOSL, int nMeasurements)
{
    float mag_v = 0.0f;
    float mag_i = 0.0f;
    float pdif = 0.0f;
