...
void CFG_Init(void)
{
    ...
    if ((CFG_GetParam(CFG_PARAM_BAND_FMIN) >= 500000ul)) CFG_SetParam(CFG_PARAM_BAND_FMIN, 500000ul);
...
void CFG_ParamWnd(void)
{
    ...
    //Added by KD8CEC, Version 0.35
    TEXTBOX_t hbPrevValueBig = {.x0 = 10, .y0 = 170, .text = "", .font = FONT_FRANBIG,
                             .fgcolor = LCD_YELLOW, .bgcolor = LCD_BLACK, .cb = _hit_prev_valueBig
                            };
    TEXTBOX_t hbNextValueBig = {.x0 = 327, .y0 = 170, .text = "", .font = FONT_FRANBIG,
                             .fgcolor = LCD_YELLOW, .bgcolor = LCD_BLACK, .cb = _hit_next_valueBig
                            };
